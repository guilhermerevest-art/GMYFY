    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50">
      <div className="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-lg">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Cadastre sua academia</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input id="nome" type="text" required value={form.nome} onChange={(e) => update('nome', e.target.value)}
          ...
          <div>
            ...
            <input id="senha" type="password" required minLength={6} value={form.senha} onChange={(e) => update('senha', e.target.value)}
              className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500" />
          </div>
